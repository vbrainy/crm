<?php 
$logo_url=base_url("public/images/logo-dark.png");
  ...
  <div class="main_detail">
    <div class="detail_view_item">
        <div class="view_frist">
            ...
            '.$this->customers_model->get_company($salesorder->customer_id)->address.'
        </div>
        <div class="view_frist">
            '.$this->customers_model->get_company($salesorder->customer_id)->address.'
        </div>
    </div>
    <div class="detail_head_titel">Invoice '.$invoice->invoice_number.'</div>
    <div class="detail_view_item">
	  ...
	  <div style="width:250px; float:left;">
		<span><b>Reference:</b><br>'.$salesorder->quotations_number.'</span>
	  </div>
    </div>
    <div class="detail_view_item">      
