...
<html>
...

 {
    ...
    $.ajax({
        ...
        type: "POST",
        url: "<?php echo base_url('customer/create_process'); ?>",
                ...
                <div class="col-sm-6 col-md-6 col-md-offset-3">
                    <div class="account-wall" style="background-color: rgba(255, 255, 255, 0);">
                        ...
                        <form class="form-signup" id="createform" role="form">
                            ...
                            <div class="clearfix">
                                <p class="pull-right m-t-20"><a href="<?php echo base_url('customer/login'); ?>"><?php echo $this->lang->line('sign_in_here'); ?></a></p>
                            </div>
                        </form>
                    </div>
                </div>
