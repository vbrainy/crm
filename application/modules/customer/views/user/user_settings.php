...
$(document).ready(function() {
	$("form[name='change_profile']").submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo base_url('customer/change_profile'); ?>",
            type: "POST",
            data: formData,
            async: false,
                        				...
                        				<div class="row">
                          					<div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                <input type="text" name="first_name" value="<?php echo $customer->first_name; ?>" class="form-control">
					                                <i class="icon-user"></i>
					                              </div>
					                            </div>
					                          </div>
					                          <div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                <input type="text" name="last_name" value="<?php echo $customer->last_name; ?>" class="form-control">
					                                <i class="icon-user"></i>
					                              </div>
					                            </div>
					                          </div>
				                        ...
				                        <div class="row">
                          					<div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                <input type="text" name="job_position" value="<?php echo $customer->job_position;?>" class="form-control">
					                    ...
					                    <div class="row">
                          					<div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                <input type="text" name="title" value="<?php echo $customer->title;?>" class="form-control">
					                          ...
					                          <div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                <input type="text" name="company" value="<?php echo $customer->company;?>" class="form-control">
