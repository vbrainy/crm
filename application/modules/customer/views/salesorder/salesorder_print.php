...
$filename = 'Order-'.$quotation->quotations_number;
...
<div class="main" style="margin-top:-90px !important">  
  <div class="main_detail">
    ...
    <div class="detail_head_titel">Order N° '.$quotation->quotations_number.'</div>
    <div class="detail_view_item">
	  <div style="width:250px; float:left;">
		<span><b>Date Ordered:</b><br>'.date('m/d/Y H:i',$quotation->date).'</span>
	  </div>
	  <div style="width:250px; float:left;">
