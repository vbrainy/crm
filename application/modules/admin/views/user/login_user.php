    ...
    <body class="account2" data-page="login" style="background-image:url('<?php echo base_url('uploads/site').'/'.config('login_bg'); ?>');background-attachment: fixed;background-position: center;background-repeat: no-repeat;background-size: cover;">
       ...
       <div class="container" id="login-block">
            ...
            <div class="account-form">
                ...
                <img src="http://192.185.86.91/~airtelcrm/airtel/public/images/logo.png" alt="bull eye" style="
    width: 280px;
    margin-top: 20%;
    margin-bottom: 6%;
">
...
"><strong>Sign in</strong> to your account</h3>
                    <div id="ajax" style="
    color: white;"><?php if($this->session->flashdata('message')){echo $this->session->flashdata('message');}?></div>
        ...
        <!-- END LOCKSCREEN BOX -->
            ...
            <p class="account-copyright" style="position: relative; margin-top: 40px;">
                <span>Copyright © <?php echo date('Y');?> </span><span><?php echo config('site_name'); ?></span>.<span>All rights reserved. Developed by Madison & Park</span>
            </p>
