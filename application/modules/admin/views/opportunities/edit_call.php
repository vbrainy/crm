...
$(document).ready(function() {
	$("form[name='edit_call']").submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo base_url('admin/opportunities/edit_call_process'); ?>",
            type: "POST",
            data: formData,
            async: false,
...
<div class="page-content">
      	  <div class="header">
            <h2><strong>Update Call</strong></h2>  
            
             
            <div class="breadcrumb-wrapper">
                
               <a href="<?php echo base_url('admin/'.$call->call_type.'/update/'.$call->call_type_id); ?>" class="btn btn-primary btn-embossed"> Back</a>
		 ...
		 <div class="row">
           	<div class="col-md-12">
                  <div class="panel">
               	 ...
               	 <input type="hidden" name="call_type_id" value="<?php echo $call->call_type_id;?>"/>
               	 <input type="hidden" name="call_type" value="<?php echo $call->call_type;?>"/>	                        	
