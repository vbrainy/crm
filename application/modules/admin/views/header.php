...
<script type="text/javascript" src="<?php echo base_url(); ?>public/assets/import_ajax.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>public/assets/chart-helper.js"></script>
  </head>
