					                        ...
					                        <div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                ...
					                                <option value=""></option>
					                                <?php foreach( $contact_persons as $contact_person){ ?>
					                                <option value="<?php echo $contact_person->id;?>" <?php if($contact_person->id==$customer->contact_person){?>selected<?php }?>><?php echo $contact_person->first_name.' '.$contact_person->last_name;?></option>
					                                <?php }?> 
				                            ...
				                            <label class="control-label"></label>
				                              <div class="append-icon">
				                                 ...
				                                 <select name="country_id" id="country_id" class="form-control" data-search="true" onChange="getstatedetails(this.value)">
					                                ...
					                                <option value="<?php echo $country->id;?>" <?php if($customer->country_id==$country->id){?> selected="selected"<?php }?>><?php echo $country->name;?></option>
					                                <?php }?> 
					                                </select>
				                                  </div>
				                                  </div>
				                                 ...
				                                 <select name="state_id" id="state_id" class="form-control" data-search="true" onChange="getcitydetails(this.value)">
					                                ...
					                                <?php $states=$this->customers_model->state_list($customer->country_id);?>
					                                <?php foreach($states as $state){ ?>
													<option value="<?php echo $state->id; ?>" <?php if($customer->state_id==$state->id){?> selected="selected"<?php }?>><?php echo $state->name; ?></option>
													<?php }?>
					                                </select>
				                                  </div>
				                             	 <div class="col-sm-6">
				                                 <select name="city_id" id="city_id" class="form-control" data-search="true">
					                                ...
					                                <?php $cities=$this->customers_model->city_list($customer->state_id);?>
					                                <?php foreach($cities as $city){ ?>
														<option value="<?php echo $city->id; ?>" <?php if($customer->city_id==$city->id){?> selected="selected"<?php }?>><?php echo $city->name; ?></option>
													<?php }?>
					                                </select>
				                                  </div>
				                            </div>
				                         ...
				                         <div class="col-sm-6">
					                            <div class="form-group">
					                              ...
					                              <div class="append-icon">
					                                ...
					                                <option value="<?php echo $region->id;?>" <?php if($region->id==$customer->regions){?>selected<?php }?>><?php echo $region->region;?></option>
					                                <?php }?> 
					                                </select>
...
<div class="col-sm-6">
                                      <div class="form-group">
                                        ...
                                        <div class="append-icon">
                                          ...
                                          <option value="<?php echo $vertical->id;?>"<?php if($vertical->id==$customer->vertical){?>selected<?php }?>><?php echo $vertical->vertical_name;?></option>
                                          <?php }?> 
                                          </select>
...
<div class="col-sm-6">
                                      <div class="form-group">
                                        ...
                                        <div class="append-icon">
                                          ...
                                          <option value="<?php echo $subvertical->id;?>"<?php if($subvertical->id==$customer->subverticals){?>selected<?php }?>><?php echo $subvertical->subvertical_name;?></option>
                                          <?php }?> 
                                          </select>
